...
async function loadDataFromApi() {
    try {
        const response = await axios.get('https://65b4864e41db5efd28669b3d.mockapi.io/Essex');
        ...
        document.getElementById('desc1').innerText = `${data.desc1_essex}`;
        document.getElementById('desc2').innerText = `${data.desc2_essex}`;
        document.getElementById('desc3').innerText = `${data.desc3_essex}`;
